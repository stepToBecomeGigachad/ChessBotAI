...
def highlight_square(screen, gs, valid_moves, square_selected):
    ...
    if len(gs.move_log) > 0:
        ...
        # Highlight cả ô bắt đầu và ô kết thúc
        screen.blit(s, (last_move.startCol * SQ_SIZE, last_move.startRow * SQ_SIZE))  # Thêm ô bắt đầu
        screen.blit(s, (
            last_move.endCol * SQ_SIZE, last_move.endRow * SQ_SIZE))
